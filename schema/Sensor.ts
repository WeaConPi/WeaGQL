...
export class SensorC {
    ...
    constructor(type: String, unit: String, value: String, sensor_name: String, sensor_type: String) {
        this.type = type;
        this.unit = unit;
        this.value = value;
...
export const SensorM: SensorModel = <SensorModel>mongoose.model<ISensor>("Sensor", schema, 'sensor');
